...
if __name__ == '__main__':
	...
	for doc in CHEMICAL_DB.find({'as_agent': {'$exists': True}}, ['as_agent', 'SMILES']):
	...
	print('done reading agents')

	with open(os.path.join(out_folder, 'agent_behavior.csv'), 'w') as fid:
		fid.write('Agent\tCounts\n')
