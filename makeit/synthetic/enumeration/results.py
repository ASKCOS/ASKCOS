...
class ForwardResult:
    """Results of a one-step forward synthesis.

    Should be used by any type of forward transformer/enumerator to store
    results and maintain uniformity!

    Attributes:
        smiles (str): SMILES string of ??
        products (list of ForwardProduct):
        smiles_to_product (dict {str: int}):
        smiles_list_to_product (dict {str: int}):
    """

    def __init__(self, smiles):
        """Initalizes ForwardResult.
